...
public class notas {
    ...
    public void Comprobacion(){
        ...
        //Comprobar que la nota de la UF1 no es superior a 10 e informar en pantalla el resultado
        if (nota1>10) {
        ...
        //Comprobar que la nota de la UF2 no es superior a 10 e informar en pantalla el resultado
        if (nota2>10) {
        ...
        //Comprobar que la nota de la UF3 no es superior a 10 e informar en pantalla el resultado
        if (nota3>10) {
    ...
    /**
     * Método que realiza el calculo del porcentaje de la nota de cada UF para el cálculo total del módulo. 
    ...
    /**
     * Método que devuelve si el alumno/a está aprobado o no dependiendo del valor de la nota definitiva
     */
    
    public void Aprobado() {

        //Condicional: entre 4 y 0 es suspenso, entre 5 y 10 es aprobado, cualquier otro valor es erróneo
        if (def<5 && def>=0) {
    ...
    public void Mostrar() {
        ...
        System.out.println("El acumuado 1 = "+ acu1);
        System.out.println("El acumuado 2 = "+ acu2);
        System.out.println("El acumuado 3 = "+ acu3);
